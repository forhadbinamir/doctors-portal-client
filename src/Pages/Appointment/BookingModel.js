        ...
        <div>
            ...
            <div class="modal modal-bottom sm:modal-middle">
                ...
                <div class="modal-box">
                    ...
                    <h3 class="font-bold text-lg text-primary">Booking Appointment:    {name}</h3>
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 justify-items-center mt-3'>
                        <input type="text" disabled readOnly value={format(date, 'PP')} class="input input-bordered w-full max-w-xs" />
